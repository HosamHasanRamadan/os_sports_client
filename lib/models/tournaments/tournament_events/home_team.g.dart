...
part of 'home_team.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

HomeTeam _$HomeTeamFromJson(Map<String, dynamic> json) => HomeTeam(
...
Map<String, dynamic> _$HomeTeamToJson(HomeTeam instance) => <String, dynamic>{
      'name': instance.name,
      'slug': instance.slug,
