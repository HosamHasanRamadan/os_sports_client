...
part of 'title_holder.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TitleHolder _$TitleHolderFromJson(Map<String, dynamic> json) => TitleHolder(
...
Map<String, dynamic> _$TitleHolderToJson(TitleHolder instance) =>
    <String, dynamic>{
      'name': instance.name,
      'slug': instance.slug,
