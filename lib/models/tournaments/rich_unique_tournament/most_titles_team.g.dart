...
part of 'most_titles_team.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

MostTitlesTeam _$MostTitlesTeamFromJson(Map<String, dynamic> json) =>
    MostTitlesTeam(
...
Map<String, dynamic> _$MostTitlesTeamToJson(MostTitlesTeam instance) =>
    <String, dynamic>{
      'name': instance.name,
      'slug': instance.slug,
